      ...
      <div className="container">
        <div className="my-10 space-y-20">
          ...
          <div className="grid lg:grid-cols-2">
            ...
            <div className="relative  mt-4 lg:mt-0 grid grid-cols-1 sm:grid-cols-3 gap-2  ">
          ...
          {/**section 2 */}
          <div className="grid lg:grid-cols-2">
            <div className="relative order-2 mt-4 lg:mt-0 lg:order-1 grid grid-cols-1 sm:grid-cols-3 gap-2  ">
              <div className="relative  border ">
                <Image
                  src="/labs/lab-2.png"
                  alt="Woodland Shoes for Men, Woodland shoes for women, Woodland apparel"
