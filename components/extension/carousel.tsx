...
type CarouselContextProps = {
  carouselOptions?: Parameters<typeof useEmblaCarousel>[0];
...
>(({ className, dir, children, onSlideChange, ...props }, ref) => {
  const { mainRef, orientation, activeIndex, direction } = useCarousel();
...
>(({ className, index, children, ...props }, ref) => {
  ...
  return (
    ...
    >
      <div
        className={`relative aspect-square  w-full flex justify-center items-center opacity-40 rounded-md transition-opacity ${
